...
const LEFT_LABELS = ["Attest", "Prove", "Mint"]
const RIGHT_LABELS = ["Verify", "Check-In", "Attend"]
  ...
  return (
    <div className="relative w-full max-w-[800px] mx-auto">
      <svg
        ...
        role="img"
        aria-label="Workflow diagram showing StarkPass flow: Attest, Prove, Mint, Verify, Check-In, Attend"
      >
        {/* Left lines */}
        {LEFT_LABELS.map((_, i) => {
          const pillX = 60
