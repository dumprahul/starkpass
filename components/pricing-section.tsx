...
const TIERS: Tier[] = [
  {
    ...
    period: "/ always",
    tag: null,
    description: "Private check-ins for users. Social login wallet + gasless flow.",
    features: [
      { text: "Social login wallet creation", included: true },
      { text: "Gasless transactions via StarkZap", included: true },
      { text: "ZK eligibility proofs", included: true },
      { text: "Private check-in token", included: true },
      { text: "Wallet history exposure", included: false },
      { text: "Sharing personal data", included: false },
    ],
    cta: "GET A PASS",
    highlighted: false,
  },
  {
    ...
    period: "",
    tag: "RECOMMENDED",
    description: "Define eligibility rules, verify proofs on Starknet, and run secure check-ins.",
    features: [
      { text: "Eligibility policies (age, role, allowlists)", included: true },
      { text: "On-chain verifier + pass issuance", included: true },
      { text: "Non-transferable event passes", included: true },
      { text: "Offline-friendly check-in mode", included: true },
      { text: "Analytics without identity", included: true },
      { text: "PII collection required", included: false },
    ],
    cta: "TALK TO US",
    highlighted: true,
  },
  {
    ...
    period: "",
    tag: null,
    description: "High-stakes events: custom circuits, attestations, and compliance support.",
    features: [
      { text: "Custom ZK circuits + audits", included: true },
      { text: "Attestation integrations", included: true },
      { text: "Dedicated StarkZap relayer capacity", included: true },
      { text: "Custom SLA", included: true },
      { text: "White-label check-in app", included: true },
...
export function PricingSection() {
  return (
    <section id="starkzap" className="w-full px-6 py-20 lg:px-12">
      {/* Section label */}
      <motion.div
      ...
      >
        <span className="text-[10px] tracking-[0.2em] uppercase text-muted-foreground font-mono">
          {"// SECTION: STARKZAP_GASLESS_ONBOARDING"}
        </span>
      ...
      >
        <div className="flex flex-col gap-3">
          <h2 className="text-2xl lg:text-3xl font-mono font-bold tracking-tight uppercase text-foreground text-balance">
            Gasless onboarding that feels native
          </h2>
          <p className="text-xs lg:text-sm font-mono text-muted-foreground leading-relaxed max-w-md">
            StarkZap relays transactions so attendees can get a pass and check in without managing gas or exposing their wallet history.
          </p>
        </div>
        <StatusLine />
      </motion.div>
      ...
      >
        <span className="text-[10px] tracking-[0.2em] uppercase text-muted-foreground font-mono">
          {"* This landing page is frontend-only for now. We’ll wire it to your backend when you share it."}
        </span>
        <div className="flex-1 border-t border-border" />
      </motion.div>
    </section>
