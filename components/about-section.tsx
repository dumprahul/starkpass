...
/* ── stat block ── */
const STATS = [
  { label: "PII_SHARED", value: "0" },
  { label: "WALLET_HISTORY_EXPOSED", value: "0" },
  { label: "GAS_FEES_REQUIRED", value: "0" },
  { label: "PROOFS_VERIFIED", value: "∞" },
]
...
export function AboutSection() {
  return (
    <section id="problem" className="w-full px-6 py-20 lg:px-12">
      {/* Section label */}
      <motion.div
        ...
        >
          ...
          <div className="absolute top-0 left-0 right-0 z-10 flex items-center justify-between px-4 py-2 bg-foreground/80 backdrop-blur-sm">
            <span className="text-[10px] tracking-[0.2em] uppercase text-background/60 font-mono">
              RENDER: private_checkin_flow.obj
            </span>
          ...
          <Image
            ...
            alt="Isometric illustration of a privacy-preserving event check-in flow"
            fill
        ...
        >
          ...
          <div className="flex-1 flex flex-col justify-between px-5 py-6 lg:py-8">
            <div className="flex flex-col gap-6">
              ...
              >
                Event eligibility without
                <br />
                <span className="text-[#ea580c]">identity leakage</span>
              </motion.h2>
              ...
              >
                <p className="text-xs lg:text-sm font-mono text-muted-foreground leading-relaxed">
                  Event platforms shouldn’t require emails, IDs, or wallet addresses just to register or attend.
                  In Web3, connecting a wallet can expose a participant’s full on-chain history and identity graph.
                </p>
                <p className="text-xs lg:text-sm font-mono text-muted-foreground leading-relaxed">
                  StarkPass uses zero-knowledge proofs on Starknet so users can prove eligibility (like age or membership)
                  without revealing the underlying personal data. Wallets are created via social login and transactions run gaslessly via StarkZap.
                </p>
              </motion.div>
