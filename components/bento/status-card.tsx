...
const REGIONS = [
  { name: "PROVER", status: "READY", latency: "~local" },
  { name: "VERIFIER", status: "ONLINE", latency: "~1 blk" },
  { name: "RELAY", status: "ONLINE", latency: "~1 tx" },
  { name: "CHECKIN", status: "READY", latency: "<1s" },
]
          ...
          >
            ...
            <div className="flex items-center gap-2">
              <span
                ...
                style={{
                  backgroundColor: region.status === "ONLINE" || region.status === "READY" ? "#ea580c" : "hsl(var(--muted-foreground))",
                }}
              />
