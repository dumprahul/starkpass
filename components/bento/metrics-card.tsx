  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 flex flex-col justify-center gap-6 p-6">
        <ScrambleNumber target="0" label="PII Shared" delay={500} />
        <ScrambleNumber target="1" label="ZK Proof / Check-in" delay={800} />
        <ScrambleNumber target="GASLESS" label="StarkZap Relays" delay={1100} />
        <ScrambleNumber target="PRIVATE" label="On-chain History Exposed" delay={1400} />
      </div>
    </div>
  )
}
